...
import { ZaahidContainer } from "../common/ZaahidContainer";
    ...
    <ZaahidContainer>
      <div className="row">
        ...
        <div className="col-lg-8 align-self-center text-center text-lg-start">
          <h4 className="fw-bold">Zaahid Azar</h4>
          <h6 id="">
            Aspiring Full-Stack Developer | IT Undergraduate | Passionate About
        ...
        <div className="col">
          <ul className="list-inline">
            {/* <li className="list-inline-item me-4">
              <a
                href="https://scholar.google.com/citations?user=ZN96WzcAAAAJ&hl=en"
                target="_blank"
              >
                <svg
            ...
            <li className="list-inline-item me-4">
              <a href="https://github.com/Zaahid09" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
            ...
            <li className="list-inline-item me-4">
              <a
                href="https://www.linkedin.com/in/Zaahid-azar/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {/* <li className="list-inline-item">
              <a
                href="https://stackoverflow.com/users/7161203/hansika-weerasena"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="row">
        <div id="Zaahid-home-badge" className="col text-center">
          <span
            className="badge"
          ...
          <span
            className="badge"
            style={{ backgroundColor: "#A3B18A", color: "black" }}
          >
            UI/UX Design
          </span>
          <span
          ...
          <span
            className="badge"
            style={{ backgroundColor: "#DDBEA9", color: "black" }}
          >
            Machine Learning
          </span>
          <span
            className="badge"
            style={{ backgroundColor: "#A68A64", color: "white" }}
          >
            Database Management
          </span>
        </div>
