...
export function HomeInsta() {
  ...
  return (
    <div className="d-none d-xl-block container shadow-sm Zaahid-container">
      <blockquote
        className="instagram-media"
        data-instgrm-permalink="https://www.instagram.com/z4hid.fy/?utm_source=ig_embed&utm_campaign=loading"
      ...
      >
        <div style={{ padding: "16px" }}>
          <a
            href="https://www.instagram.com/z4hid.fy/?utm_source=ig_embed&utm_campaign=loading"
            style={{
